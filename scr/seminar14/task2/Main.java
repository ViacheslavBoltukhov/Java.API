...
public class Main {
    public static void main(String[] args) {
       ...
       int[] lst = new int[]{1, 2, 3, 4, 5};
        checkError(checkers(lst, 3, 7));
        checkError(checkers(lst, 7, 4));
        checkError(checkers(null, 3, 4));
        checkError(checkers(lst, 3, 4));
    }

    public static Integer checkers(int[] lst, int minSize, int elem) {
        if (lst == null) {
            return -3;
        }
